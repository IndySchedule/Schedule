...
assert(indexSource.includes('What’s new in 1.4.0') && indexSource.includes('We’re sorry we missed your messages') && indexSource.includes('School administrator restrictions blocked communication outside the organization') && indexSource.includes('Please resend your message using Settings → Send Feedback.'), 'The release notice explains feedback, apologizes for missed messages, and asks users to resend');
